package com.thuannp.securepass.ui.social;
...
public class SocialFragment extends Fragment {
    private static final String PROVIDER = "social";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        mViewModel.getAllSocial().observe(getViewLifecycleOwner(), new Observer<List<CredModel>>() {
            @Override
